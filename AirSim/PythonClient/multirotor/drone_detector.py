...
class QuadController:
    def __init__(self, args):
        ...
        self.bounding_box_xy = self.args["position"]  #boundary thresholds for maintaining traking towards center of the view
    ...
    def img_tracker(self, client):
        while self.running:
            ...
            png_raw = cv2.imdecode(airsim.string_to_uint8_array(rawImage), cv2.IMREAD_COLOR)
