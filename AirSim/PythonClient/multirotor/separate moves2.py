...
#Fly the drones
for i in range (4): client.moveToPositionAsync(waypoints_drone2[i][0],waypoints_drone2[i][1],waypoints_drone2[i][2],1,vehicle_name='Drone2').join()
